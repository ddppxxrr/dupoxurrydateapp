        ...
        >
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    {memory.musicUrl && (
                      <div className="flex items-center gap-3 bg-dpxr-bg px-5 py-2.5 rounded-full border border-dpxr-border/50 shadow-sm overflow-hidden group">
                        ...
                        <audio
                          ref={audioRef}
                          src={resolveProxyUrl(memory.musicUrl)}
                          autoPlay
                          playsInline
                          loop
                          muted={isMuted}
          ...
          <div className="p-8 md:p-12 bg-dpxr-bg">
            ...
            {(() => {
              ...
              return (
                <div className={isSingleItem ? "max-w-2xl mx-auto" : "columns-1 md:columns-2 gap-6 [column-fill:_balance]"}>
                   {memory.mediaType === 'video' ? (
                     <div className="break-inside-avoid w-full mb-6">
                       <video
                         src={resolveProxyUrl(memory.mediaUrls?.[0] || (memory as any).mediaUrl)}
                         controls
                         className="w-full rounded-3xl object-contain bg-black max-h-[70vh] shadow-sm"
                       />
                     </div>
                   ) : (
        ...
        {selectedImage && (
          ...
          >
            ...
            <motion.img
              ...
              src={resolveProxyUrl(selectedImage)}
              alt="Full size view"

...
export const MemoryCard: React.FC<MemoryCardProps> = ({ memory, onDelete, onEdit, onView, isAdmin }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative h-[180px] sm:h-[210px] md:h-[230px] shrink-0 rounded-2xl overflow-hidden bg-bento-bg border border-bento-border mb-4">
        {isVideo ? (
          <video
      ...
      <div className="relative z-10 flex-grow flex flex-col justify-between">
        <h3 className="text-xl font-serif text-bento-text mb-2 leading-tight line-clamp-2 md:line-clamp-3">
          {memory.title}
        </h3>
